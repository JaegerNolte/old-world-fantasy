...
public class ModMerchantResultSlot extends Slot {

    private final ModMerchantContainer slots;
    private final Player player;
    private int removeCount;
    private final ModMerchant merchant;

    public ModMerchantResultSlot(Player pPlayer, ModMerchant pMerchant, ModMerchantContainer pSlots, int pSlot, int pXPosition, int pYPosition) {

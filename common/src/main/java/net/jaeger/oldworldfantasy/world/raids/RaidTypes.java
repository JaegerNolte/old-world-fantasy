...
public enum RaidTypes {
    ...
    BEASTMEN("beastmen", effectHolder(ModEffects.BEASTMEN_OMEN.get())),
    GREENSKINS("greenskins", effectHolder(ModEffects.GREENSKIN_OMEN.get()));
//    EMPIRE("empire",ModEffects.BEASTMEN_OMEN.getHolder().get());
    ...
    private static Holder<MobEffect> effectHolder(MobEffect effect){

package net.jaeger.oldworldfantasy.item.items.tools;
...
import static net.jaeger.oldworldfantasy.item.items.weapons.ModWeaponItem.createDefaultAttributeModifiersBuilder;
...
public class ModHoeItem extends HoeItem {
    ...
    public ModHoeItem(ModItemTier material, WeaponType type) {

package net.jaeger.oldworldfantasy.entity.mobs.human.empire.swordsmen;
...
public class EmpireSwordsmen extends AbstractHuman {

    private static final EntityDataAccessor<Integer> VARIANT =
            SynchedEntityData.defineId(EmpireSwordsmen.class, EntityDataSerializers.INT);

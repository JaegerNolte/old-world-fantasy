...
public class OrcWarboss extends AbstractGreenskin {
    ...
    public OrcWarboss(EntityType<? extends ModRaider> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new OrcWarbossBreakDoorGoal(this));
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        controllers.add(new AnimationController<>(this, "movement", 1, state -> {
            if (state.isMoving()) {
                ...
                return state.setAndContinue(RawAnimation.begin().thenLoop("ANIM_ORCWARBOSS_WALKING"));
            } else {
                state.setControllerSpeed(1);
                return state.setAndContinue(RawAnimation.begin().thenLoop("ANIM_ORCWARBOSS_IDLE"));
            }
        }
        ));
    ...
    static class OrcWarbossBreakDoorGoal extends BreakDoorGoal {
        public OrcWarbossBreakDoorGoal(Mob p_34112_) {
            super(p_34112_, 6, OrcWarboss.DOOR_BREAKING_PREDICATE);
            this.setFlags(EnumSet.of(Flag.MOVE));
        }

        @Override
        public boolean canContinueToUse() {
            OrcWarboss orc = (OrcWarboss) this.mob;

package net.jaeger.oldworldfantasy.entity.mobs.greenskin.orc.client;
...
public class OrcRenderer extends GeoEntityRenderer<Orc> {
    ...
    public OrcRenderer(EntityRendererProvider.Context context) {
        ...
        addRenderLayer(new BlockAndItemGeoLayer<>(this,
            ...
            @Override
            protected ItemDisplayContext getTransformTypeForStack(GeoBone bone, ItemStack stack, Orc animatable) {
                return ItemDisplayContext.THIRD_PERSON_RIGHT_HAND;
            }

            @Override
            protected void renderStackForBone(PoseStack poseStack, GeoBone bone,
                                              ItemStack stack, Orc animatable, MultiBufferSource bufferSource,

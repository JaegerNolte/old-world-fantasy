...
public class StoneTrollRenderer extends GeoEntityRenderer<StoneTroll> {

    public StoneTrollRenderer(EntityRendererProvider.Context context) {
        super(context, new StoneTrollModel());
        ...
        addRenderLayer(new BlockAndItemGeoLayer<>(this,
            ...
            @Override
            protected ItemDisplayContext getTransformTypeForStack(GeoBone bone, ItemStack stack, StoneTroll animatable) {
                return ItemDisplayContext.THIRD_PERSON_RIGHT_HAND;
            }

            @Override
            protected void renderStackForBone(PoseStack poseStack, GeoBone bone,
                                              ItemStack stack, StoneTroll animatable, MultiBufferSource bufferSource,
    ...
    @Override
    public ResourceLocation getTextureLocation(StoneTroll animatable) {
        return OldWorldFantasy.res("textures/entity/troll/stone_troll.png");
    }

    @Override
    public void scaleModelForRender(float widthScale, float heightScale, PoseStack poseStack,
                                    StoneTroll animatable, BakedGeoModel model, boolean isReRender,
                                    float partialTick, int packedLight, int packedOverlay) {

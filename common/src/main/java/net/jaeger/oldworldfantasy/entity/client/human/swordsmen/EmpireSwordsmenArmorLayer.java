...
public class EmpireSwordsmenArmorLayer extends GeoRenderLayer<EmpireSwordsmen> {

    private final EmpireSwordsmenArmorModel armorModel = new EmpireSwordsmenArmorModel();

    public EmpireSwordsmenArmorLayer(GeoRenderer<EmpireSwordsmen> renderer) {
        super(renderer);
    }

    @Override
    public void render(PoseStack poseStack, EmpireSwordsmen animatable, BakedGeoModel bakedModel, RenderType renderType,

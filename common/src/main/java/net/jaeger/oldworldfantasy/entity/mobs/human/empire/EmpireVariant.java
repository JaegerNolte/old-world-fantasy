...
public enum EmpireVariant {
    ...
    public static final Map<EmpireVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(EmpireVariant.class), map -> {
                map.put(EmpireVariant.BLONDE, OldWorldFantasy.res("textures/entity/empire/empire_soldier.png"));
                map.put(EmpireVariant.BROWN, OldWorldFantasy.res("textures/entity/empire/empire_soldier_1.png"));
            });
}

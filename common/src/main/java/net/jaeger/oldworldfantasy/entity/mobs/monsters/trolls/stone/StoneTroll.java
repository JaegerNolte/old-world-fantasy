package net.jaeger.oldworldfantasy.entity.mobs.monsters.trolls.stone;

import net.jaeger.oldworldfantasy.entity.ModEntityTags;
import net.jaeger.oldworldfantasy.entity.ai.goals.TrollAttackGoal;
...
public class StoneTroll extends AbstractTroll {

    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    private static final RawAnimation ATTACK_ANIMATION = RawAnimation.begin().thenPlay("ANIM_TROLL_ATTACKING");
    private final String attack = "axe_attack";
    private final int ambientSoundInterval = 1000;

    public StoneTroll(EntityType<? extends ModRaider> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new TrollAttackGoal(this, 1.5, false, attack));
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        controllers.add(new AnimationController<>(this, "movement", 1, state -> {
            if (state.isMoving()) {
                ...
                return state.setAndContinue(RawAnimation.begin().thenLoop("ANIM_TROLL_WALKING"));
            } else {
                state.setControllerSpeed(1);
                return state.setAndContinue(RawAnimation.begin().thenLoop("ANIM_TROLL_IDLE"));
            }
        }
        ));

...
public class EmpireCrossbowmenRenderer extends GeoEntityRenderer<EmpireCrossbowmen> {

    public EmpireCrossbowmenRenderer(EntityRendererProvider.Context context) {
        super(context, new EmpireCrossbowmenModel());
        this.shadowRadius = 0.5f;
        this.addRenderLayer(new EmpireCrossbowmenArmorLayer(this));
        ...
        addRenderLayer(new BlockAndItemGeoLayer<>(this,
            ...
            @Override
            protected ItemDisplayContext getTransformTypeForStack(GeoBone bone, ItemStack stack, EmpireCrossbowmen animatable) {
            ...
            protected void renderStackForBone(PoseStack poseStack, GeoBone bone,
                                              ItemStack stack, EmpireCrossbowmen animatable, MultiBufferSource bufferSource,
                                              float partialTick, int packedLight, int packedOverlay) {
                if (bone.getName().equals("LeftHandItem")) {
                    poseStack.translate(0.2, -0.9, -0.2);
    ...
    @Override
    public ResourceLocation getTextureLocation(EmpireCrossbowmen animatable) {
        return EmpireVariant.LOCATION_BY_VARIANT.get(animatable.getVariant());
    }

    @Override
    public void scaleModelForRender(float widthScale, float heightScale, PoseStack poseStack,
                                    EmpireCrossbowmen animatable, BakedGeoModel model, boolean isReRender,
                                    float partialTick, int packedLight, int packedOverlay) {

...
public class ModMerchantMenu extends AbstractContainerMenu {
    ...
    private final ModMerchant trader;
    private final ModMerchantContainer tradeContainer;
    private int merchantLevel;
    private boolean showProgressBar;
    private boolean canRestock;

    public ModMerchantMenu(int pContainerId, Inventory pPlayerInventory) {
        this(pContainerId, pPlayerInventory, new ModClientSideMerchant(pPlayerInventory.player));
    }

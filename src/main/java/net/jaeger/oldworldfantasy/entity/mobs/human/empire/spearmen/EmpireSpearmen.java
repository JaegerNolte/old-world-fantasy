package net.jaeger.oldworldfantasy.entity.mobs.human.empire.spearmen;
...
public class EmpireSpearmen extends AbstractHuman {

    private static final EntityDataAccessor<Integer> VARIANT =
            SynchedEntityData.defineId(EmpireSpearmen.class, EntityDataSerializers.INT);
    ...
    public EmpireSpearmen(EntityType<? extends ModRaider> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new EmpireSpearmen.SoldierBreakDoorGoal(this));
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor pLevel, DifficultyInstance pDifficulty, MobSpawnType pSpawnType, @Nullable SpawnGroupData pSpawnGroupData) {
        ...
        this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(ModItems.IMPERIAL_PIKE.get()));
    ...
    static class SoldierBreakDoorGoal extends BreakDoorGoal {
        public SoldierBreakDoorGoal(Mob p_34112_) {
            super(p_34112_, 6, EmpireSpearmen.DOOR_BREAKING_PREDICATE);
            this.setFlags(EnumSet.of(Flag.MOVE));
        }

        @Override
        public boolean canContinueToUse() {
            EmpireSpearmen soldier = (EmpireSpearmen) this.mob;

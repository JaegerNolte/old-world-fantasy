package net.jaeger.oldworldfantasy.entity.mobs.human.empire.captain;
...
public class EmpireCaptain extends AbstractHuman {

    public EmpireCaptain(EntityType<? extends ModRaider> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new EmpireCaptain.SoldierBreakDoorGoal(this));
    ...
    static class SoldierBreakDoorGoal extends BreakDoorGoal {
        public SoldierBreakDoorGoal(Mob p_34112_) {
            super(p_34112_, 6, EmpireCaptain.DOOR_BREAKING_PREDICATE);
            this.setFlags(EnumSet.of(Flag.MOVE));
        }

        @Override
        public boolean canContinueToUse() {
            EmpireCaptain soldier = (EmpireCaptain) this.mob;

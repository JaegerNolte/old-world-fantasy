...
public class EmpireArchLectorArmorLayer extends GeoRenderLayer<EmpireArchLector> {

    private final EmpireArchLectorArmorModel armorModel = new EmpireArchLectorArmorModel();

    public EmpireArchLectorArmorLayer(GeoRenderer<EmpireArchLector> renderer) {
        super(renderer);
    }

    @Override
    public void render(PoseStack poseStack, EmpireArchLector animatable, BakedGeoModel bakedModel, RenderType renderType,

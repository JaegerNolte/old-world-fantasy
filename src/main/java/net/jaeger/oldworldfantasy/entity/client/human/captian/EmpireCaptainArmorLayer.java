...
public class EmpireCaptainArmorLayer extends GeoRenderLayer<EmpireCaptain> {

    private final EmpireCaptainArmorModel armorModel = new EmpireCaptainArmorModel();

    public EmpireCaptainArmorLayer(GeoRenderer<EmpireCaptain> renderer) {
        super(renderer);
    }

    @Override
    public void render(PoseStack poseStack, EmpireCaptain animatable, BakedGeoModel bakedModel, RenderType renderType,

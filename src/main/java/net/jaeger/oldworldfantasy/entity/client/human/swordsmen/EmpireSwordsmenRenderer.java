...
public class EmpireSwordsmenRenderer extends GeoEntityRenderer<EmpireSwordsmen> {
    ...
    public EmpireSwordsmenRenderer(EntityRendererProvider.Context context) {
        super(context, new EmpireSwordsmenModel());
        this.shadowRadius = 0.5f;
        this.addRenderLayer(new EmpireSwordsmenArmorLayer(this));
        ...
        addRenderLayer(new BlockAndItemGeoLayer<>(this,
            ...
            @Override
            protected ItemDisplayContext getTransformTypeForStack(GeoBone bone, ItemStack stack, EmpireSwordsmen animatable) {
            ...
            protected void renderStackForBone(PoseStack poseStack, GeoBone bone,
                                              ItemStack stack, EmpireSwordsmen animatable, MultiBufferSource bufferSource,
    ...
    public void scaleModelForRender(float widthScale, float heightScale, PoseStack poseStack,
                                    EmpireSwordsmen animatable, BakedGeoModel model, boolean isReRender,
                                    float partialTick, int packedLight, int packedOverlay) {

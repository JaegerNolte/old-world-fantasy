...
public class EmpireArchLectorRenderer extends GeoEntityRenderer<EmpireArchLector> {

    public EmpireArchLectorRenderer(EntityRendererProvider.Context context) {
        super(context, new EmpireArchLectorModel());
        this.shadowRadius = 0.5f;
        this.addRenderLayer(new EmpireArchLectorArmorLayer(this));
        ...
        addRenderLayer(new BlockAndItemGeoLayer<>(this,
            ...
            @Override
            protected ItemDisplayContext getTransformTypeForStack(GeoBone bone, ItemStack stack, EmpireArchLector animatable) {
            ...
            protected void renderStackForBone(PoseStack poseStack, GeoBone bone,
                                              ItemStack stack, EmpireArchLector animatable, MultiBufferSource bufferSource,
    ...
    @Override
    public ResourceLocation getTextureLocation(EmpireArchLector animatable) {
        return OldWorldFantasyMod.res("textures/entity/empire/empire_archlector.png");
    }

    @Override
    public void scaleModelForRender(float widthScale, float heightScale, PoseStack poseStack,
                                    EmpireArchLector animatable, BakedGeoModel model, boolean isReRender,
                                    float partialTick, int packedLight, int packedOverlay) {

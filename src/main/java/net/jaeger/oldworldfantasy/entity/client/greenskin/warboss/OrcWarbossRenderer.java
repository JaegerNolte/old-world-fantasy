...
public class OrcWarbossRenderer extends GeoEntityRenderer<OrcWarboss> {
    ...
    public OrcWarbossRenderer(EntityRendererProvider.Context context) {
        ...
        addRenderLayer(new BlockAndItemGeoLayer<>(this,
            ...
            @Override
            protected ItemDisplayContext getTransformTypeForStack(GeoBone bone, ItemStack stack, OrcWarboss animatable) {
                return ItemDisplayContext.THIRD_PERSON_RIGHT_HAND;
            }

            @Override
            protected void renderStackForBone(PoseStack poseStack, GeoBone bone,
                                              ItemStack stack, OrcWarboss animatable, MultiBufferSource bufferSource,

...
public class GorAnimations {
    public static final AnimationDefinition ANIM_GOR_IDLE = AnimationDefinition.Builder.withLength(2.0F).looping()
    ...
    public static final AnimationDefinition ANIM_GOR_WALKING = AnimationDefinition.Builder.withLength(2.0F).looping()
            ...
            .addAnimation("head", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    ...
                    new Keyframe(1.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(2.0F, KeyframeAnimations.posVec(0.0F, -3.0F, -3.0F), AnimationChannel.Interpolations.LINEAR)
            ))
            .build();
}
...
public class EmpireSpearmenArmorLayer extends GeoRenderLayer<EmpireSpearmen> {

    private final EmpireSpearmenArmorModel armorModel = new EmpireSpearmenArmorModel();

    public EmpireSpearmenArmorLayer(GeoRenderer<EmpireSpearmen> renderer) {
        super(renderer);
    }

    @Override
    public void render(PoseStack poseStack, EmpireSpearmen animatable, BakedGeoModel bakedModel, RenderType renderType,

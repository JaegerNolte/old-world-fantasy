...
public class RangedBowAttackGoal<T extends net.minecraft.world.entity.Mob & RangedAttackMob & GeoEntity> extends Goal {
    ...
    public RangedBowAttackGoal(T pMob, double pSpeedModifier, int pAttackIntervalMin, float pAttackRadius, String rawAnimation) {
        this.mob = pMob;
            ...
            if (this.mob.isUsingItem()) {
                if (!flag && this.seeTime < -60) {
                    ...
                    if (i >= 20) {
                        ...
                        this.mob.triggerAnim("attack", rawAnimation); // TODO: Sync timing
